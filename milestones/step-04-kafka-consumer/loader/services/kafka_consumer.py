...
class IngestConsumerService:
    ...
    def process_message(self, message_val: Dict[str, Any]) -> None:
        ...
        # Requirement: Log Received Message, Row Number, Job ID
        logger.info("Received Message | Job ID: %s | Row Number: %d | timestamp: %s", job_id, row_number, timestamp)
        # Explicit test confirmation requirement print format:
